...
IBPSimplify[expr_,varSym_]:=Module[
...
Print["Loading file"]
Get["CollectTensorsInput.mx"];
Print["Collecting tensors"];
CollectTensorsOutput=CollectTensorsInput//CollectTensors;
Print["Saving result"];
DumpSave["CollectTensorsOutput.mx", {CollectTensorsOutput}];
Print["Saved result"];
